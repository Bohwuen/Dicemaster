...
function Me.BookEditor_InsertPage( before )
	...
	if before then
		tinsert( DiceMasterBookFrame.bookData.pages, #DiceMasterBookFrame.bookData.pages, "" )
	else
...
function Me.BookFrame_Update()
	...
	DiceMasterBookPageText:SetTextColor( textColor[1] or 0, textColor[2] or 0, textColor[3] or 0 )
