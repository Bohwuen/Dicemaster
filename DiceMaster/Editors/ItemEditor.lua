...
function Me.ItemEditorQuality_OnClick(self, arg1, arg2, checked)
	UIDropDownMenu_SetText(DiceMasterItemEditor.itemQuality, ITEM_QUALITY_COLORS[ arg1 ].hex .. self:GetText())
...
function Me.ItemEditor_LoadEditItem( itemIndex )
	...
	-- set quality
	UIDropDownMenu_SetText(editor.itemQuality, ITEM_QUALITY_COLORS[ data.quality ].hex .. ITEM_QUALITIES[ data.quality + 1 ])
