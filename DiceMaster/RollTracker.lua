...
function Me.OnChatMessage( message, sender ) 
	local icons = {
		{"estrella","gold", "star", "rt1"},
		{"naranja","orange", "circle", "coin", "rt2"},
		{"morado","purple", "diamond", "rt3"},
		{"verde","green", "triangle", "rt4"},
		{"luna","silver", "moon", "rt5"},
		{"azul","blue", "square", "rt6"},
		{"rojo","red", "cross", "x", "rt7"},
		{"blanco","white", "skull", "rt8"}
	}
